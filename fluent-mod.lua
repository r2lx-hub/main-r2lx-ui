...
local aa = {
	...
	[47] = function()
		...
		local af = {Names = {"Dark", "Darker", "Light", "Aqua", "Amethyst", "Rose", "Grey"}}
...
[54] = function()
    ...
    return {
        ...
        AcrylicBorder = Color3.fromRGB(90, 90, 90),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(120, 120, 120), Color3.fromRGB(80, 80, 80)),
        AcrylicNoise = 0.92,
        TitleBarLine = Color3.fromRGB(100, 100, 100),
        Tab = Color3.fromRGB(120, 120, 120),
        Element = Color3.fromRGB(130, 130, 130),
        ElementBorder = Color3.fromRGB(100, 100, 100),
        InElementBorder = Color3.fromRGB(110, 110, 110),
        ElementTransparency = 0.86,
        ToggleSlider = Color3.fromRGB(130, 130, 130),
        ToggleToggled = Color3.fromRGB(50, 50, 50),
        SliderRail = Color3.fromRGB(130, 130, 130),
        DropdownFrame = Color3.fromRGB(140, 140, 140),
        DropdownHolder = Color3.fromRGB(90, 90, 90),
        DropdownBorder = Color3.fromRGB(80, 80, 80),
        DropdownOption = Color3.fromRGB(130, 130, 130),
        Keybind = Color3.fromRGB(130, 130, 130),
        Input = Color3.fromRGB(130, 130, 130),
        InputFocused = Color3.fromRGB(40, 40, 40),
        InputIndicator = Color3.fromRGB(150, 150, 150),
        Dialog = Color3.fromRGB(90, 90, 90),
        DialogHolder = Color3.fromRGB(80, 80, 80),
        DialogHolderLine = Color3.fromRGB(75, 75, 75),
        DialogButton = Color3.fromRGB(90, 90, 90),
        DialogButtonBorder = Color3.fromRGB(120, 120, 120),
        DialogBorder = Color3.fromRGB(95, 95, 95),
        DialogInput = Color3.fromRGB(110, 110, 110),
